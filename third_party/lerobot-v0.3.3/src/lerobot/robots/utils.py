...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "so101_follower_dual":
        from .so101_follower_dual import SO101FollowerDual

        return SO101FollowerDual(config)
    ...
    elif config.type == "remote_follower":
        from .remote_follower import RemoteFollower

        return RemoteFollower(config)
